...
const HI704_SENSOR_INIT_INFO HI704_Initial_Setting_Info[] =
{
	...
	{0x70, 0x42},   //For Y decay //48 20130115  //3a
        //{0x70, 0x41},   //For Y decay //48 tidailiao  
    {0x76, 0x22},
    {0x77, 0x02},   
    {0x78, 0x12},
    {0x79, 0x27},
    ...
    {0x83, 0x02},//expTime:0x83,0x84,0x85
    {0x84, 0xf9},
    {0x85, 0xb8}, 
...
static void HI704_Set_VGA_mode(void)
{
    ...
    HI704_write_cmos_sensor(0x10, 0x25);  //0x21
...
void HI704_night_mode(kal_bool enable)
{
    ...
    if(enable)
    {
       ...
       else 
       {
            ...
            HI704_write_cmos_sensor(0x84, 0x17);
            HI704_write_cmos_sensor(0x85, 0x04);
            HI704_write_cmos_sensor(0x86, 0x00);
            HI704_write_cmos_sensor(0x87, 0xfa);

            HI704_write_cmos_sensor(0x88, 0x04);
            HI704_write_cmos_sensor(0x89, 0xf1);
            HI704_write_cmos_sensor(0x8a, 0xa0);
    ...
    else
    {
        ...
        else 
        {
            ...
            HI704_write_cmos_sensor(0x89, 0x17);
            HI704_write_cmos_sensor(0x8a, 0x04);
...
{       HI704_write_cmos_sensor(0x03, 0x10);
        ...
        HI704_write_cmos_sensor(0x62, 0x82);
        HI704_write_cmos_sensor(0x63, 0x90);
    spin_lock(&hi704_yuv_drv_lock);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&hi704_yuv_drv_lock);
    HI704_write_cmos_sensor(0x03, 0x10);
    HI704_write_cmos_sensor(0x61, 0x85);//a0
    HI704_write_cmos_sensor(0x62, 0x90);//b0
    return ERROR_NONE;
}	/* HM3451Capture() */
...
BOOL HI704_set_param_wb(UINT16 para)
{
    ...
    case AWB_MODE_AUTO:
		...
		HI704_write_cmos_sensor(0x83, 0x50);                                 
...
BOOL HI704_set_param_effect(UINT16 para)
{
   SENSORDB("[Enter]HI704 set_param_effect func:para = %d\n",para);
    ...
    case MEFFECT_OFF:
        {
        HI704_write_cmos_sensor(0x03, 0x10);
        HI704_write_cmos_sensor(0x11, 0x03);//43
        ...
        HI704_write_cmos_sensor(0x20, 0x06);//7
        HI704_write_cmos_sensor(0x21, 0x05);//7
        HI704_write_cmos_sensor(0x90, 0x04);//7
        HI704_write_cmos_sensor(0x91, 0x03);//7		
        }
        break;
    case MEFFECT_SEPIA:
        {
...
BOOL HI704_set_param_exposure(UINT16 para)
{
    ...
    case AE_EV_COMP_00:  // +0 EV
		HI704_write_cmos_sensor(0x40,0x90);//88 20130115
                //HI704_write_cmos_sensor(0x40,0x84);//88 tidailiao
        break;    
