...
//				  0x35,0x40}},  
	...
	{0xB1,	31,	{0x00,0x50,0x44,0xEA,0x90,0x08,0x11,0x11,
				  0x71,0x2F,0x37,0xAF,0x2F,0x42,0x0B,0x6E,
	...
	{0xB4,	31,	{0x80,0x08,0x00,0x32,0x10,0x05,0x32,0x13,
				  0x31,0x32,0x10,0x08,0x37,0x01,0x20,0x07,
				  0x37,0x02,0x45,0x08,0x30,0x25,0x04,0x00,
	...
	{0xE0,	35,	{0x79,0x07,0x12,0x14,0x3F,0x3F,0x3F,0x1F,
				  0x41,0x06,0x0C,0x0E,0x12,0x14,0x12,0x13,
				  0x14,0x1F,0x07,0x12,0x14,0x3F,0x3F,0x3F,
				  0x1F,0x41,0x06,0x0C,0x0E,0x12,0x14,0x12,
				  0x13,0x14,0x1F}}, //GAMMA

	{0x53,	1,	{0x40}}, 

	{0xB6,	4,	{0x00,0XBD,0X00,0XBD}}, //VCOM  flicker   // BA

	{0x36,	1,	{0x00}},   //SCAN  DIRECTION  
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.horizontal_frontporch				= 32;//32
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;

		// Bit rate calculation
		params->dsi.pll_div1= 22; //29,30 : bad		// fref=26MHz, fvco=fref*(div1+1)	(div1=0~63, fvco=500MHZ~1GHz)
...
LCM_DRIVER hx8379a_dsi_vdo_9070_lcm_drv = 
{
    .name			= "hx8379a_dsi_vdo_9070",
