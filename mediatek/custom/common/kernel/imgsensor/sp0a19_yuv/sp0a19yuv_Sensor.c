...
{  
	...
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0x03,0x00);
	SP0A19_write_cmos_sensor(0x04,0xf0);
	SP0A19_write_cmos_sensor(0x06,0x00);
	SP0A19_write_cmos_sensor(0x09,0x02);
	SP0A19_write_cmos_sensor(0x0a,0x8a);
	SP0A19_write_cmos_sensor(0xf0,0x50);
	SP0A19_write_cmos_sensor(0xf1,0x00);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x90,0x0e);
	SP0A19_write_cmos_sensor(0x92,0x01);
	SP0A19_write_cmos_sensor(0x98,0x50);
	SP0A19_write_cmos_sensor(0x99,0x00);
	SP0A19_write_cmos_sensor(0x9a,0x01);
	SP0A19_write_cmos_sensor(0x9b,0x00);
	...
	SP0A19_write_cmos_sensor(0x56,0x0d);
	SP0A19_write_cmos_sensor(0x59,0x0e);
	
	SP0A19_write_cmos_sensor(0x89,0x06);
	SP0A19_write_cmos_sensor(0x8a,0x0d);
	SP0A19_write_cmos_sensor(0x9c,0x0d);
	SP0A19_write_cmos_sensor(0x9d,0x0e);
	
	SP0A19_write_cmos_sensor(0x81,0xe0);
	SP0A19_write_cmos_sensor(0x82,0xe0);
	SP0A19_write_cmos_sensor(0x83,0xc0);
	SP0A19_write_cmos_sensor(0x84,0xb0);
	
	SP0A19_write_cmos_sensor(0x85,0xe0);
	SP0A19_write_cmos_sensor(0x86,0xc0);
	SP0A19_write_cmos_sensor(0x87,0xb0);
	SP0A19_write_cmos_sensor(0x88,0x90);
	
	SP0A19_write_cmos_sensor(0x5a,0xff);
	SP0A19_write_cmos_sensor(0x5b,0xe0);
	SP0A19_write_cmos_sensor(0x5c,0xc0);
	SP0A19_write_cmos_sensor(0x5d,0x50);
	...
	SP0A19_write_cmos_sensor(0xe8,0x24);
	SP0A19_write_cmos_sensor(0xec,0x30);
	SP0A19_write_cmos_sensor(0xe9,0x24);
	SP0A19_write_cmos_sensor(0xed,0x30);
	
	SP0A19_write_cmos_sensor(0xea,0x20);
	SP0A19_write_cmos_sensor(0xef,0x2c);
	SP0A19_write_cmos_sensor(0xeb,0x18);
	SP0A19_write_cmos_sensor(0xf0,0x28);
	...
	SP0A19_write_cmos_sensor(0x98,0xd2);
	SP0A19_write_cmos_sensor(0x99,0xdb);
	SP0A19_write_cmos_sensor(0x9a,0xe3);
	SP0A19_write_cmos_sensor(0x9b,0xeb);
	SP0A19_write_cmos_sensor(0xfd,0x01);
	SP0A19_write_cmos_sensor(0x8d,0xf2);
	SP0A19_write_cmos_sensor(0x8e,0xf9);
	SP0A19_write_cmos_sensor(0xfd,0x00);
	...
	SP0A19_write_cmos_sensor(0xd3,0x8c);
	SP0A19_write_cmos_sensor(0xd4,0x8c);
	SP0A19_write_cmos_sensor(0xd6,0x8c);
	SP0A19_write_cmos_sensor(0xd7,0x8c);
	
	SP0A19_write_cmos_sensor(0xfd,0x00);
	SP0A19_write_cmos_sensor(0xdd,0x7a);
	SP0A19_write_cmos_sensor(0xde,0xa0);
...
UINT32 SP0A19Open(void)
{
	...
	#if 0 //def DEBUG_SENSOR  //gepeiwei   120903
	...
	fp = filp_open("/storage/sdcard0/sp2528_sd", O_RDONLY , 0); 
	if (IS_ERR(fp)) 
	{ 
		fromsd = 0;   
	...
	Sleep(10);
	SP0A19_Sensor_Init();	
	Sleep(200);	//add by sp_yjp,20130227
