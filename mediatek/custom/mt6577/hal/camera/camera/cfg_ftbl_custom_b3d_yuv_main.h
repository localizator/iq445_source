 ...
 ************************************************************************************************/
#ifndef _CFG_FTBL_CUSTOM_B3D_YUV_MAIN_H_
#define _CFG_FTBL_CUSTOM_B3D_YUV_MAIN_H_


//  1: Enable the custom-specific features of YUV-Main sensor.
//  0: Disable the custom-specific features of YUV-Main sensor.
#define CUSTOM_FEATURE_B3D_YUV_MAIN 1
...
//------------------------------------------------------------------------------
END_GETFINFO_B3D_YUV_MAIN()
};  //  namespace NSMain
};  //  namespace NSYUV
};  //  namespace NSB3D

#endif // _CFG_FTBL_CUSTOM_B3D_YUV_MAIN_H_
