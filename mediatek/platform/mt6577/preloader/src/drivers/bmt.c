...
static int load_bmt_data(int start, int pool_size)
{
	...
	//mtk_nand_read_page_hw (0, COMMON_BUFFER_ADDR, COMMON_BUFFER_ADDR+2048);
//MSG(INIT, "[%s]0x%x,0x%x,0x%x,0x%x \n",__FUNCTION__, *((UINT32 *)COMMON_BUFFER_ADDR),*(((UINT32 *)COMMON_BUFFER_ADDR)+1),*(((UINT32 *)COMMON_BUFFER_ADDR)+2),*(((UINT32 *)COMMON_BUFFER_ADDR)+3));

	//memset(COMMON_BUFFER_ADDR,0xAA,4096);
	//memset(oob_buf,0xAA,128);
	//mtk_nand_read_page_hw (0x3FF80, COMMON_BUFFER_ADDR, COMMON_BUFFER_ADDR+2048);
