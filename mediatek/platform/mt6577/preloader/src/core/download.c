...
//pull down lcm when before mobile download ,ensure the glass state in the lcm is OK.
static void pull_down_lcm(void)
{
	//edit by Magnum 2012-9-11 power down lcd before jump to DA
/*	printf("Magnum start power down VDI\n");
	pmic_config_interface(0x091 +0x01, 0x0,0x1,0x0); 
	printf("Magnum end power down VDI\n");*/
