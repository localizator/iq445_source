...
void bq24158_set_ac_current(void)
{
    ...
    bq24158_config_interface_reg(0x06,0x10); //set ISAFE
     ...
     {          
         ...
         //bq24158_set_ac_charging_current(0x01);               //bq24158 CON4 IOCHARGE
    ...
    {    
        if ( BMT_status.charger_type == STANDARD_HOST ) 
        {
            ...
            {    
                ...
                {
                    bq24158_config_interface_reg(0x05,0x04);
                    //bq24158_set_ac_charging_current(0x02);
...
int BAT_CheckBatteryStatus_bq24158(void)
{
    ...
    if (Enable_BATDRV_LOG >= 1) {
        printk("[BATTERY:ADC:bq24158] VCHR:%d BAT_SENSE:%ld I_SENSE:%ld TBAT:%d (%d)\n", 
