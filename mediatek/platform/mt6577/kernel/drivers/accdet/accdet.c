...
#define DW_KEY_HIGH_THR	 (3200000)//(500000) //0.50v=500000uv
#define DW_KEY_THR		 (3100000)//(240000) //0.24v=240000uv
#define UP_KEY_THR            (1000000)//(90000) //0.09v=90000uv
#define MD_KEY_THR		 (0)
...
#ifdef ACCDET_KEY_FEATURE	//neal
#define    ACC_MEDIA_PLAYPAUSE  3
#define    ACC_MEDIA_NEXT       4
#endif
...
{
#if	1//def ACCDET_MULTI_KEY_FEATURE
