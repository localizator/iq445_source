...
#ifndef _MTK_DISPLAY_ADAPTER_IDISPLAY_ADAPTER_H_
#define _MTK_DISPLAY_ADAPTER_IDISPLAY_ADAPTER_H_
//
...
*
*******************************************************************************/
class IDisplayAdapter : public virtual RefBase
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interfaces.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////    Instantiation.
    ...
    static  IDisplayAdapter*    createInstance();
...
public:     ////
	...
	*/	
     ...
     *
     */
    virtual bool                enableDisplay(bool const isRecordingHint)       = 0;
    virtual bool                disableDisplay(bool const cancel_buffer = true) = 0;
    /**
     *
     */
    virtual bool                setFrameProvider(FrameNotifier*const frameNotifier) = 0;

};


}; // namespace android
#endif  //_MTK_DISPLAY_ADAPTER_IDISPLAY_ADAPTER_H_
