...
#ifndef _MTK_ICAM_ADAPTER_H_
#define _MTK_ICAM_ADAPTER_H_
//
...
*
*******************************************************************************/
class ICamAdapter : public FrameNotifier, public virtual RefBase
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Interfaces.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:     ////
    ...
    /**
     * Set the buffer provider.
     */
    virtual void                setBufferProvider(IBufferProvider*const pBufferProvider) = 0;
    ...
    /** 
     * Return the reference to camera parameters.
     */
    ...
    /**
     * Query Quickview's format(w/h/fmt) .
     */
    virtual status_t queryQvFmt(int32_t &width, int32_t &height, String8 &s8FrmFormat) = 0;

};


}; // namespace android
#endif  //_MTK_ICAM_ADAPTER_H_
