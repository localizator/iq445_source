...
*
*******************************************************************************/
#define MY_LOGV(fmt, arg...)    CAM_LOGV("[ICamDevice::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGD(fmt, arg...)    CAM_LOGD("[ICamDevice::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGI(fmt, arg...)    CAM_LOGI("[ICamDevice::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGW(fmt, arg...)    CAM_LOGW("[ICamDevice::%s] "fmt, __FUNCTION__, ##arg)
#define MY_LOGE(fmt, arg...)    CAM_LOGE("[ICamDevice::%s] "fmt, __FUNCTION__, ##arg)
