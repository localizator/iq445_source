...
#ifndef _MTK_ICAM_DEVICE_H_
#define _MTK_ICAM_DEVICE_H_
//
...
public:     ////    Attributes.
    ...
    static inline
    ICamDevice*
    getIDev(camera_device*const device)
    {
        return  (NULL == device) ? NULL : reinterpret_cast<ICamDevice*>(device->priv);
    }
