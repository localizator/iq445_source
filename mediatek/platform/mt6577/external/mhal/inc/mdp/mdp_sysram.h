...
#ifndef __MDP_SYSRAM_H__
#define __MDP_SYSRAM_H__

#include "mdp_datatypes.h"

typedef enum 
{
    MDPSYSRAM_SUBCAT_NORMAL = 0,
    MDPSYSRAM_SUBCAT_DESCRIPTOR,
    MDPSYSRAM_SUBCAT_SUBROTSYSRAM
