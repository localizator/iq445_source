...
/* DSP MDIF Register */
#define MDIF_SH_DRSTVCTL(base)  (*((volatile unsigned short*)(base + 0x10)))
#define MDIF_SH_DRSTVCTH(base)  (*((volatile unsigned short*)(base + 0x14)))
#define MDIF_LCOK(base)					(*((volatile unsigned short*)(base + 0x1C)))
...
#define MD_MDIF_BASE        (0xD0080000)

#define FCOREL2_BASE        (0xD9040000) // 0xD9xx_xxxx <--> 0xFFxx_xxxx (0xFF040000)
#define FC_CONFIG_BASE      (0xD9090000) // 0xD9xx_xxxx <--> 0xFFxx_xxxx (0xFF090000)
#define FLEX_L2_BANK_CTRL   ((volatile unsigned int *)(FCOREL2_BASE  + 0x0050))
#define FCORE_WAYEN_CTRL    ((volatile unsigned int *)(FC_CONFIG_BASE + 0x0028))

/* extern function */
extern void sc_mod_init(void);
extern void sc_mod_exit(void);
extern void sc_force_ap_control(kal_bool force);
extern void gpt_one_shot_irq(unsigned int ms);
extern void mt6575_sleep(u32 timeout, kal_bool en_deep_idle);

extern void protect_md(void);
extern void reset_md(void);